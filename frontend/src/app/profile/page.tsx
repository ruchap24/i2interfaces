            ...
            <div className="flex flex-col md:flex-row gap-6">
              <div className="relative">
                <Avatar className="h-32 w-32">
                  ...
                  <AvatarFallback className="text-3xl bg-blue-500/20 text-blue-400">
                    {profile.name.charAt(0).toUpperCase()}
                  </AvatarFallback>
                </Avatar>
                <button
                  onClick={() => fileInputRef.current?.click()}
                  className="absolute bottom-0 right-0 p-2 rounded-full bg-blue-600 hover:bg-blue-700 text-white shadow-lg"
                >
              ...
              <div className="flex-1">
                ...
                {profile.headline && (
                  <p className="text-xl text-gray-400 mt-1">{profile.headline}</p>
                )}
                {profile.location && (
